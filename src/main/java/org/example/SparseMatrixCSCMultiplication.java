...
public class SparseMatrixCSCMultiplication {
    ...
    SparseMatrixCSCMultiplication(double[] values, int[] rowIndices, int[] colPointers, int rows, int cols) {
        this.values = values;
    ...
    public SparseMatrixCSCMultiplication multiply(SparseMatrixCSCMultiplication B) {
        if (this.cols != B.rows) {
        ...
        return new SparseMatrixCSCMultiplication(resultValuesArray, resultRowIndicesArray, resultColPointersArray, this.rows, B.cols);
    }

    public static SparseMatrixCSCMultiplication convertToCSC(double[][] matrix) {
        ...
        return new SparseMatrixCSCMultiplication(values, rowIndices, colPointers, rows, cols);
    }
